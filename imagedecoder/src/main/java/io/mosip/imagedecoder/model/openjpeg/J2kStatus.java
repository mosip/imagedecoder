...
/**
 * Values that specify the status of the decoding process when decoding the main
 * header. These values may be combined with a | operator.
 */
public enum J2kStatus {
	...
	/**
	 * < the decoding process must not expect a EOC marker because the codestream is
	 * truncated
	 */
